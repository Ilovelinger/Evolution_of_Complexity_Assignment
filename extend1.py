...
Original file is located at
    https://colab.research.google.com/drive/1OYK3OTYX-IM8ZE15RExFwe0dSmifpWmF
"""
...
def createIndividual2(n):
    ...
    new_individual.fitness = Ackley(new_individual.bitsString)
    ...
    for i in range(s):
        for j in range(n):
            ...
            for e in range(4):
                ...
                offspringFitnessList.append(Ackley(offspring1.bitsString))
                offspringFitnessList.append(Ackley(offspring2.bitsString))
            index3 = offspringFitnessList.index(min(offspringFitnessList))
            if index3 == 0:
                bestOffSpring = offspring1
            else:
                bestOffSpring = offspring2
            if Ackley(bestOffSpring.bitsString) < Ackley(member.bitsString):
    ...
    for i in range(len(population)):
        for j in range(len(population[i])):
            ...
            while k != len(population):
                ...
                k = k + 1
            member.fitness = Ackley(integralIndividualstring)
    ...
    while generation != iteration:
        ...
        for i in range(n):
            ...
            while k != len(population):
                ...
                k = k + 1
            theChild.fitness = Ackley(integralIndividualstring2)
...
def show2(n, iteration):
    ...
    for i in range(5):
        Y1 = CCGAWithSextualSelection(n, iteration, 2)
    ...
    plt.legend(["CCGA With Sexual Selection(R = 2)", "CCGA-1"])
    plt.show()
